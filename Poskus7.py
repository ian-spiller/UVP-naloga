...
@bottle.get("/")
def osnovna_stran():
    return bottle.template("test-internet-dostop6.tpl",seznam_firm=seznam_firm)
...
#MORM SPREMENIT PREDEN ODAM KER SAM JST MAM TA PROBLEM
...
#RAST
    ...
    return bottle.template("Poskus7-iztop-tplprobam.tpl",leta=leta,kratica=kratica,cena=cena,
